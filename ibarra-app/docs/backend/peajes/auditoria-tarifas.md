...
# peajes_f14_test.sql (B-01..B-16 + prune huérfanos + F14-9 categoria_calculated) + peajes_mercosur_patron_a_test.sql + regresiones F01/F06/pwbi
```
...
- Migraciones: `20260812140628`…`20260812140653_peajes_tarifas_*` + `20260814190600_peajes_recalcular_prune_orphans` + `20260814204300_peajes_tarifas_categoria_calculated`.

...
- Puede editar únicamente migraciones/funciones Peajes, `docs/08-sql/peajes/**` y las implementaciones de servicios Peajes. No edita modelos/contratos, wizard, catálogos, plantillas ni rutas.
...
5. Por cada cambio, documentar SQL reproducible en `docs/08-sql/peajes/{feature}/`, con verificación Local CLI y una sección que marque Producción como “no autorizada/no ejecutada”. No incluir claves ni datos sensibles.

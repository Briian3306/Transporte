/**
 * Contratos F14 — Auditoría de tarifas normalizadas.
 * Consumidos por `/peajes/auditoria-tarifas` y `PeajesAuditoriaTarifasSupabaseService`.
 */
...
export interface TarifaGrupoSimilar {
  ...
  ratio: number;
  pendientes: number;
  /** IDs ordenados por importe asc — pairing para bulk-apply. */
  tarifa_ids?: string[];
}

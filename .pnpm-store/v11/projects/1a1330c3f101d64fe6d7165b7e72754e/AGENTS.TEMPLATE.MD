...
`docs/PRD-Peajes.md`: un asistente guiado que carga, transforma, mapea, valida y
...
1. `docs/PRD-Peajes.md` — spec funcional y de datos. Ante cualquier duda, el PRD
...
1. Leer `docs/PRD-Peajes.md` para el comportamiento exacto de la feature

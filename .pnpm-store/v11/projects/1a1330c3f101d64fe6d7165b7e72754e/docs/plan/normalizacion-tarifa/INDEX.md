# Índice — Normalización tarifaria

## Resumen

Esta carpeta reúne el PRD, el plan técnico original y los planes de evolución de la normalización y auditoría tarifaria del módulo Peajes. Los documentos son planificación; el comportamiento implementado se documenta en `docs/06-components/peajes/` y `docs/backend/peajes/`.
...
- [Auditoría de tarifas implementada](../../06-components/peajes/auditoria-tarifas.md)

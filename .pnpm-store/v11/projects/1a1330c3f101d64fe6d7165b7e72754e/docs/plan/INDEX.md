...
- F14-18 Refresh Tarifas en Paso 9: [PLAN_refresh-tarifas-paso9.md](./refactor-tarifas-importe/PLAN_refresh-tarifas-paso9.md) — implementado en CLI local (`passing`); detección en lote current/histórica/nueva, diálogo reutilizando el tablero PICO/NO_PICO y confirmación explícita. Backend: [refresh-tarifas-paso9.md](../backend/peajes/refresh-tarifas-paso9.md).

 ...
 * Catálogo/carga/plantillas/pasadas/tarifario concretos son `providedIn: 'root'`;
 * estos tokens los cablean en el injector de rutas Peajes.
 * TarifaRefreshServiceImpl no es root: inyecta PEAJES_TARIFARIO_SERVICE.
 */

...
export const ESTACION_DOCK_SUD = 'estacion-dock-sud';
export const ESTACION_GUTIERREZ = 'estacion-gutierrez';
export const ESTACION_SAMBOROMBON = 'estacion-samborombon';
...
const ESTACIONES: CatalogEstacion[] = [
  { id: ESTACION_DOCK_SUD, nombre: 'DOCK SUD', peaje_id: PEAJE_AUBASA },
  { id: ESTACION_HUDSON, nombre: 'HUDSON', peaje_id: PEAJE_AUBASA },
  { id: ESTACION_SAMBOROMBON, nombre: 'SAMBOROMBON', peaje_id: PEAJE_AUBASA },
  { id: ESTACION_GUTIERREZ, nombre: 'GUTIERREZ', peaje_id: PEAJE_AUBASA },
...
function seedState(): { tarifas: TarifaIdentidad[]; importes: TarifaImporteRow[] } {
  ...
  add('tarifa-dock-ida-1-np', ESTACION_DOCK_SUD, 'NO_PICO', 1, 'IDA', 'ti-d-ida-1-np', 5500);
  add('tarifa-dock-ida-1-p', ESTACION_DOCK_SUD, 'PICO', 1, 'IDA', 'ti-d-ida-1-p', 6000);
  add('tarifa-dock-ida-2-np', ESTACION_DOCK_SUD, 'NO_PICO', 2, 'IDA', 'ti-d-ida-2-np', 7000);
  add('tarifa-dock-ida-2-p', ESTACION_DOCK_SUD, 'PICO', 2, 'IDA', 'ti-d-ida-2-p', 7500);
  add('tarifa-dock-vue-1-np', ESTACION_DOCK_SUD, 'NO_PICO', 1, 'VUELTA', 'ti-d-vue-1-np', 5700);
  add('tarifa-dock-vue-1-p', ESTACION_DOCK_SUD, 'PICO', 1, 'VUELTA', 'ti-d-vue-1-p', 6200);
  add('tarifa-dock-vue-2-np', ESTACION_DOCK_SUD, 'NO_PICO', 2, 'VUELTA', 'ti-d-vue-2-np', 7200);
  add('tarifa-dock-vue-2-p', ESTACION_DOCK_SUD, 'PICO', 2, 'VUELTA', 'ti-d-vue-2-p', 7700);

  add('tarifa-sambo-ida-1-np', ESTACION_SAMBOROMBON, 'NO_PICO', 1, 'IDA', 'ti-s-ida-1-np', 8000);
  add('tarifa-sambo-ida-1-p', ESTACION_SAMBOROMBON, 'PICO', 1, 'IDA', 'ti-s-ida-1-p', 8500);
  add('tarifa-sambo-vue-1-np', ESTACION_SAMBOROMBON, 'NO_PICO', 1, 'VUELTA', 'ti-s-vue-1-np', 8100);
  add('tarifa-sambo-vue-1-p', ESTACION_SAMBOROMBON, 'PICO', 1, 'VUELTA', 'ti-s-vue-1-p', 8600);

  add('tarifa-gut-ambas-1-np', ESTACION_GUTIERREZ, 'NO_PICO', 1, 'AMBAS', 'ti-g-1-np', 5000);
  add('tarifa-gut-ambas-1-p', ESTACION_GUTIERREZ, 'PICO', 1, 'AMBAS', 'ti-g-1-p', 5500);
  add('tarifa-gut-ambas-2-np', ESTACION_GUTIERREZ, 'NO_PICO', 2, 'AMBAS', 'ti-g-2-np', 6500);
  add('tarifa-gut-ambas-2-p', ESTACION_GUTIERREZ, 'PICO', 2, 'AMBAS', 'ti-g-2-p', 7000);

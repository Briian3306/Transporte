...
| 03  | Frontend Plantillas & Motor | `.agents/skills/peajes-plantillas-builder` + `.agents/skills/peajes-transformaciones-motor` + `.agents/skills/peajes-testing-transformaciones` | `src/app/components/peajes/plantillas/**` (UI builder + motor Strategy/Builder en TS)                                                                                                                                                                                      | 00 (contratos); usa mocks hasta que 01 entregue las tablas de plantillas |
